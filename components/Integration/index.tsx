      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Flexible Tech Stack Solutions, Anywhere, Anytime.`,
              description: `Unlock the potential of your projects with our swapable tech stack, seamlessly integrating cloud services, DevOps solutions, and cutting-edge web app development tools.`,
            }}
          />
